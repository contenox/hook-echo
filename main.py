...
@app.get("/health", operation_id="health_check_get", summary="Health Check", tags=["Monitoring"])
@app.head("/health", operation_id="health_check_head", summary="Health Check (HEAD)", tags=["Monitoring"])
...
@app.get("/ready", operation_id="ready_check", summary="Readiness Check", tags=["Monitoring"])
